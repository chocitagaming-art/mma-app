...
// youtube-nocookie iframe after the user clicks (keeps pages fast, no 3rd-party
// player scripts until intent). On play, move focus to the iframe so keyboard /
// screen-reader users don't lose context when the trigger button unmounts.
